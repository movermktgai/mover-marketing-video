<p align="center">
	<img width="150" height="150" src="apps/web/public/android-chrome-512x512.png" alt="Mover Marketing Video logo">
</p>

<h1 align="center">Mover Marketing Video</h1>

<p align="center">
	Source release of Mover Marketing AI's white-labeled Cap fork for self-hosted screen recording and async video sharing.
</p>

<p align="center">
	<a href="https://github.com/CapSoftware/Cap">Upstream Cap</a>
	 |
...
> Private deployment URLs, credentials, object-storage endpoints, and recording/share-link data are intentionally excluded. Configure your own values via environment variables before exposing an instance.
