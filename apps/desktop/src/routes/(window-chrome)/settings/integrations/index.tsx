	...
	const apps = [
		{
			name: "Google Drive",
			description:
				"Connect Google Drive for new shareable link uploads. Mover Marketing Video stores new videos in a private app folder in your Drive and continues serving them after normal access checks.",
	...
	return (
		<div class="cap-settings-page flex flex-col h-full custom-scroll">
			<SettingsPageContent>
				<Section
					title="Integrations"
					description="Configure integrations to extend Mover Marketing Video and connect with third-party services."
				>
					<div class="space-y-3">
						<For each={apps}>
							{(app) => (
