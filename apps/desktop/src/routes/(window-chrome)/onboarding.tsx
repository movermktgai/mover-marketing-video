...
import { isSelfHostedServer } from "~/utils/plans";
import {
	commands,
	type OSPermission,
...
function FaqStep(props: { active: boolean }) {
	...
	return (
		<div class="flex flex-col items-center justify-center min-h-full px-12 py-6 gap-6">
			...
			>
				<FaqItem question="Is Mover Marketing Video ready for team use?">
					<p class="text-[13px] text-gray-10 leading-relaxed">
						Yes. This self-hosted build includes long recordings, sharing,
						workspace collaboration, and commercial use for Mover Marketing AI.
					</p>
				</FaqItem>
				...
				<FaqItem question="Where are my recordings stored?">
					<p class="text-[13px] text-gray-10 leading-relaxed">
						...
						they're also uploaded to Mover Marketing Video for easy sharing. You
				...
				<FaqItem question="How does sharing work?">
					<p class="text-[13px] text-gray-10 leading-relaxed">
						...
						via Mover Marketing Video or save locally.
					</p>
				</FaqItem>
			</div>
