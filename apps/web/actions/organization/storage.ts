...
const proRequiredMessage =
	"Organization integrations are included for approved Mover Marketing Video accounts. Please contact the Mover Marketing AI team if access is unavailable.";
