...
const watchVideoDescription = `Watch this video on ${PRODUCT_NAME}`;
		...
		Effect.map(
			Option.match({
				onNone: () =>
					awaitRecording
						? {
								title: `${PRODUCT_NAME}: Preparing Video`,
				...
				onSome: ([video]) => {
					...
					return {
						title: `${video.name} | ${PRODUCT_NAME}`,
						description: watchVideoDescription,
						openGraph: {
							images: [
								{
									url: previewImageUrl,
