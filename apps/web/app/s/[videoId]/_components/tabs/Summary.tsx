					...
					<div className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg border border-blue-100">
						<div className="mb-3 text-blue-600">
							<svg
								...
								stroke="currentColor"
							>
								<title>AI features unavailable</title>
								<path
									strokeLinecap="round"
						...
						<p className="mb-4 text-sm leading-relaxed text-gray-600">
							AI-powered titles, summaries, and chapters are included where
							backend services are configured for approved accounts. Contact the
							Mover Marketing AI team if access is unavailable.
						</p>
					</div>
				</div>
			</div>
							...
							<div className="divide-y">
								{aiData.chapters.map((chapter) => (
									<button
										type="button"
										key={chapter.start}
										className="flex w-full items-center p-2 rounded transition-colors text-left cursor-pointer hover:bg-gray-100"
