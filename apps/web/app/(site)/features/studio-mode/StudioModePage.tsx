	...
	content: {
		...
		faq: {
			...
			items: [
				...
				{
					question: "How does access work for Studio Mode?",
					answer:
						"Studio Mode is included for approved Mover Marketing Video accounts and does not require a separate Cap subscription checkout.",
				},
			],
		},
		video: {
