	...
	content: {
		...
		faq: {
			...
			items: [
				...
				{
					question: "How long can approved users record in Instant Mode?",
					answer:
						"Approved Mover Marketing Video accounts are treated as upgraded in this self-hosted build, so long recordings are included. Final length still depends on the desktop build and upload path validation.",
				},
				{
					question: "Are my recordings secure in Instant Mode?",
					answer:
						"Recordings are handled through the configured Mover Marketing Video infrastructure, with access controls for sharing and password protection where enabled.",
				},
				{
					question: "Can viewers download my recordings?",
					answer:
						"By default, viewers watch recordings in the browser. Download and password controls depend on the configured sharing settings for the recording and organization.",
				},
				{
				...
				{
					question: "Do I need to upgrade for team features?",
					answer:
						"No. Recording, sharing, workspaces, and collaboration features are included for approved Mover Marketing Video accounts where the backend services are configured.",
				},
				{
					question: "Can I edit recordings made in Instant Mode?",
					answer:
						"Editing and downloads are included for approved accounts where the video type and backend processing path support them.",
				},
			],
		},
		video: {
		...
		cta: {
			...
			description:
				"Use Mover Marketing Video Instant Mode for faster communication and better collaboration on approved team accounts.",
			primaryButton: "Download for Free",
			secondaryButton: "Open Dashboard",
		},
	},
	customSections: {
		showVideo: true,
