	...
	if (!subscription) {
		return (
			<Card className="flex flex-wrap gap-6 justify-between items-center w-full">
				<CardHeader>
					<CardTitle>Mover Marketing Video access included</CardTitle>
					<CardDescription>
						Paid Cap subscriptions are disabled for this self-hosted build.
						Approved accounts include recording, sharing, custom domains, AI
						features where configured, and workspace collaboration.
					</CardDescription>
				</CardHeader>
			</Card>
		);
