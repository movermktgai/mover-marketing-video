...
export const agenciesContent: SeoPageContent = {
	...
	migrationGuide: {
		title: "Getting Started with Mover Marketing Video for Your Agency",
		steps: [
			"Download Mover Marketing Video for approved team members once the branded app is available",
			"Use your configured app domain for branded share links",
			"Connect approved storage for complete data ownership where configured",
	...
	cta: {
		...
		subtitle:
			"Ready to get started? Open the dashboard and unlock your team workflow.",
				...
				<div className="flex relative z-10 flex-col md:mt-[20vh] mt-[12vh] px-5 w-full h-full">
					<div className="mx-auto text-center wrapper wrapper-sm">
						...
						>
							<Button
								variant="blue"
								href={agenciesContent.cta.buttonHref ?? "/login"}
								size="lg"
