...
const comparisonTable: {
	...
	rows: [
		...
		[
			"Access",
			{ text: "Included for approved accounts", status: "positive" },
...
const steps = [
	{
		title: "Use an approved account",
		description:
			"Google Drive storage is included where configured for approved Mover Marketing Video accounts and organizations.",
	},
	{
